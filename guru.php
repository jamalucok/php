        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'rokib.php' ? 'active' : ''; ?>" aria-current="page" href="guru.php">Guru</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'rokib.php' ? 'active' : ''; ?>" aria-current="page" href="siswa.php">Siswa</a>
                    </li>
                    <li class="nav-item">
    ...
    $(document).ready(function() {
        ...
        $('.detail').click(function() {
            ...
            $.ajax({
                ...
                method: "post",
                data: {
                    dataGuru: dataGuru // tambahkan tanda kutip pada dataSiswa
                },
