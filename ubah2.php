             ...
             <div class="col-md">
                 <form action="" method="post" enctype="multipart/form-data">
                     <div class="mb-3">
                         ...
                         <input type="text" class="form-control w-50" id="nama_siswa" value="<?= $siswa['nama_siswa']; ?>" name="nama_siswa" autocomplete="off" required>                      
                    </div>
                    <div class="mb-3">
                         <label for="kelas" class="form-label">Kelas</label>
                         <input type="textr" class="form-control w-50" id="kelas" value="<?= $siswa['kelas']; ?>" name="kelas" autocomplete="off" required>                    
                    </div>
                    <div class="mb-3">
                         <label for="jurusan" class="form-label">Jurusa</label>
                    ...
                    <div class="mb-3">
                         ...
                         <input type="textr" class="form-control w-50" id="alamat" value="<?= $siswa['alamat']; ?>" name="alamat" autocomplete="off" required>                    
                    </div>
               </div>
                <hr>
