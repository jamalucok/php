<?php 
session_start();
//jika tidak bisa login balik lagi kelogin.php
...
<body>
    ...
    <div class="container">
        ...
        <div class="row my-2">
            <div class="col-md">
                <a href="addData2.php" class="btn btn-primary"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data</a>
                <a href="export2.php" target="_blank" class="btn btn-success ms-1"><i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp;Ekspor ke Excel</a>
                <a href="print2.php" target="_blank" class="btn btn-success ms-1"><i class="bi bi-printer"></i>&nbsp;Print Data</a>      
            </div>
        </div>
        <div class="row my-3">
            <div class="col-md">
                        ...
                        <?php foreach ($siswa as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="ubah2.php?nis=<?= $row['nis']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |

                                    <a href="hapus2.php?nis=<?= $row['nis']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['nama_siswa']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold text-uppercase" id="detail">Detail Data Sekolah</h5>
    ...
    $(document).ready(function() {
        ...
        $('.detail').click(function() {
            ...
            $.ajax({
                ...
                method: "post",
                data: {
                    dataSiswa: dataSiswa // tambahkan tanda kutip pada dataSiswa
                },
