<?php 
session_start();
//jika tidak bisa login balik ke login.php
// jika masuk halaman ini melalui url, maka langsung menuju halam login
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Jurusan Sekolah</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
