                            ...
                            <tr align="center">
                                ...
                                <td><?= $row['alamat']; ?></td>
                                 <td>
                                    ...
                                    <a href="ubah.php2?nip=<?= $row['nis']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |

                                    <a href="hapus.php2?nis=<?= $row['nis']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['nama_siswa']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
