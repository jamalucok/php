...
<body>
    ...
    <div class="container">
         <div class="row my-2">
             <div class="col-md">
                 <h3 class="fw-bold text-uppercase"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Guru</h3>
             </div>
         </div>
         <div class="row my-2">
             <div class="col-md">
                 <form action="" method="post" enctype="multipart/form-data">
                     <div class="mb-3">
                         ...
                         <input type="text" class="form-control w-50" id="nis" placeholder="Masukkan Nama Guru" min="1"      name="nama_guru" autocomplete="off" required>
                     </div>
                     <div class="mb-3">
                         <label for="nip" class="form-label">NIP</label>
                         <input type="text" class="form-control form-control-md w-50" id="nip" placeholder="Masukkan NIP" name="nip" autocomplete="off" required>
                     </div>
                     <div class="mb-3">
                         <label for="jabatan" class="form-label">Jabatan</label>
                         <input type="text" class="form-control w-50" id="jabatan" placeholder="Masukkan Jabatan"      name="jabatan" maxlength="50" autocomplete="off" required>
                     </div>
                     <div class="mb-3">
